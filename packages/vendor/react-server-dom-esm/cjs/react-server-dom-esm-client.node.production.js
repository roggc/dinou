...
exports.createFromNodeStream = function (
  ...
  var response = new ResponseInstance(
    ...
    JSCompiler_object_inline__rowState_188 = 0,
    JSCompiler_object_inline__rowID_189 = 0,
    JSCompiler_object_inline__rowTag_190 = 0,
    JSCompiler_object_inline__rowLength_191 = 0,
    JSCompiler_object_inline__buffer_192 = [];
  stream.on("data", function (chunk) {
    if ("string" === typeof chunk) {
      for (
        var i = 0,
          rowState = JSCompiler_object_inline__rowState_188,
          rowID = JSCompiler_object_inline__rowID_189,
          rowTag = JSCompiler_object_inline__rowTag_190,
          rowLength = JSCompiler_object_inline__rowLength_191,
        ...
        if (-1 < lastIdx) {
          if (0 < JSCompiler_object_inline__buffer_192.length)
            throw Error(
              "String chunks need to be passed in their original shape. Not split into smaller string chunks. This is a bug in the wiring of the React streams."
            );
          ...
          JSCompiler_object_inline__buffer_192.length = 0;
        } else if (chunk.length !== i)
          throw Error(
            "String chunks need to be passed in their original shape. Not split into smaller string chunks. This is a bug in the wiring of the React streams."
          );
      }
      JSCompiler_object_inline__rowState_188 = rowState;
      JSCompiler_object_inline__rowID_189 = rowID;
      JSCompiler_object_inline__rowTag_190 = rowTag;
      JSCompiler_object_inline__rowLength_191 = rowLength;
    } else {
      rowLength = 0;
      chunkLength = JSCompiler_object_inline__rowState_188;
      rowID = JSCompiler_object_inline__rowID_189;
      i = JSCompiler_object_inline__rowTag_190;
      rowState = JSCompiler_object_inline__rowLength_191;
      for (rowTag = chunk.length; rowLength < rowTag; ) {
        ...
        if (-1 < lastIdx)
          ...
          JSCompiler_object_inline__buffer_192.push(chunk);
          rowState -= chunk.byteLength;
          break;
        }
      }
      JSCompiler_object_inline__rowState_188 = chunkLength;
      JSCompiler_object_inline__rowID_189 = rowID;
      JSCompiler_object_inline__rowTag_190 = i;
      JSCompiler_object_inline__rowLength_191 = rowState;
    }
  });
