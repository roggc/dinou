  ...
  (function () {
    ...
    exports.createFromNodeStream = function (
      ...
      var response$jscomp$0 = new ResponseInstance(
        ...
        JSCompiler_object_inline__rowState_240 = 0,
        JSCompiler_object_inline__rowID_241 = 0,
        JSCompiler_object_inline__rowTag_242 = 0,
        JSCompiler_object_inline__rowLength_243 = 0,
        JSCompiler_object_inline__buffer_244 = [];
        ...
        if ("string" === typeof chunk) {
          if (void 0 !== response$jscomp$0.weak.deref()) {
            for (
              var response = unwrapWeakResponse(response$jscomp$0),
                i = 0,
                rowState = JSCompiler_object_inline__rowState_240,
                rowID = JSCompiler_object_inline__rowID_241,
                rowTag = JSCompiler_object_inline__rowTag_242,
                rowLength = JSCompiler_object_inline__rowLength_243,
              ...
              if (-1 < lastIdx) {
                if (0 < JSCompiler_object_inline__buffer_244.length)
                  throw Error(
                    "String chunks need to be passed in their original shape. Not split into smaller string chunks. This is a bug in the wiring of the React streams."
                  );
                ...
                JSCompiler_object_inline__buffer_244.length = 0;
              } else if (chunk.length !== i)
                throw Error(
                  "String chunks need to be passed in their original shape. Not split into smaller string chunks. This is a bug in the wiring of the React streams."
                );
            }
            JSCompiler_object_inline__rowState_240 = rowState;
            JSCompiler_object_inline__rowID_241 = rowID;
            JSCompiler_object_inline__rowTag_242 = rowTag;
            JSCompiler_object_inline__rowLength_243 = rowLength;
          }
        } else if (void 0 !== response$jscomp$0.weak.deref()) {
          rowID = unwrapWeakResponse(response$jscomp$0);
          rowLength = 0;
          chunkLength = JSCompiler_object_inline__rowState_240;
          response = JSCompiler_object_inline__rowID_241;
          i = JSCompiler_object_inline__rowTag_242;
          rowState = JSCompiler_object_inline__rowLength_243;
          for (rowTag = chunk.length; rowLength < rowTag; ) {
            ...
            if (-1 < lastIdx)
              ...
              JSCompiler_object_inline__buffer_244.push(chunk);
              rowState -= chunk.byteLength;
              break;
            }
          }
          JSCompiler_object_inline__rowState_240 = chunkLength;
          JSCompiler_object_inline__rowID_241 = response;
          JSCompiler_object_inline__rowTag_242 = i;
          JSCompiler_object_inline__rowLength_243 = rowState;
        }
      });
